...
def add_arguments_transformer_for_cond1(group):
    """Add Transformer common arguments."""
    group.add_argument(
        "--transformer-init",
        type=str,
    ...
    # Decoder
    group.add_argument(
        "--cond-dlayers", default=1, type=int, help="Number of decoder layers"
    )
    group.add_argument(
        "--cond-dunits", default=320, type=int, help="Number of decoder hidden units"
    )
    return group
