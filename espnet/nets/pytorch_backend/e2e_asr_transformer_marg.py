...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def forward(self, xs_pad, ilens, ys_pad, ys_wrd_pad):
        """E2E forward.
        ...
        if self.mtlalpha == 0.0:
            ...
            if self.training:
                loss_ctc = self.ctc(hs_pad.view(batch_size, -1, self.adim), hs_len, ys_wrd_pad)
            else:
    ...
    def calculate_all_attentions(self, xs_pad, ilens, ys_pad, ys_wrd_pad):
        ...
        self.eval()
        with torch.no_grad():
            self.forward(xs_pad, ilens, ys_pad, ys_wrd_pad)
        ret = dict()
    ...
    def calculate_all_ctc_probs(self, xs_pad, ilens, ys_pad, ys_wrd_pad):
