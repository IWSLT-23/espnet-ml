            ...
            for layer_idx, encoder_layer in enumerate(self.encoders):
                ...
                if (
                    ...
                    if self.use_conditioning:
                        ...
                        for cat in ctc_softmax.keys():
                            if intermediate_result is None:
                                intermediate_result = ctc_softmax[cat].softmax(encoder_output)
                            else:
                                intermediate_result = intermediate_result + ctc_softmax[cat].softmax(encoder_output)
