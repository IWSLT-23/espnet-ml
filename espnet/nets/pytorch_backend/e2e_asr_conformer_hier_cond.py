...
from espnet.nets.pytorch_backend.conformer.encoder_hier_cond import Encoder
from espnet.nets.pytorch_backend.e2e_asr_transformer_hier_cond import E2E as E2ETransformer
