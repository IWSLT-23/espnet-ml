...
from espnet2.asr.decoder.fairseq_transformers_decoder import (  # noqa: H301
    FairseqTransformersDecoder,
)
...
from espnet2.asr.encoder.fairseq_transformers_encoder import (
    FairseqTransformersEncoder,
)
...
from espnet2.st.espnet_model_mbart_fairseq import ESPnetSTModel
...
decoder_choices = ClassChoices(
    ...
    classes=dict(
        ...
        fairseq_transformers=FairseqTransformersDecoder,
    ),
...
md_encoder_choices = ClassChoices(
    ...
    classes=dict(
        ...
        branchformer=BranchformerEncoder,
        e_branchformer=EBranchformerEncoder,
        fairseq_transformers=FairseqTransformersEncoder,
    ),
    type_check=AbsEncoder,
    default=None,
    optional=True,
...
class STTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            type=str,
            default="bpe",
            choices=["bpe", "char", "word", "phn", "hugging_face","fairseq"],
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetSTModel:
        ...
        if getattr(args, "hier_encoder", None) is not None:
            ...
            hier_encoder = hier_encoder_class(
                input_size=encoder_output_size, **args.hier_encoder_conf)
        else:
            hier_encoder = None
