...
from espnet2.st.espnet_model_mbart import ESPnetSTModel
#from espnet2.st.espnet_model_md2 import ESPnetSTModelMD2
#from espnet2.st.espnet_model import ESPnetSTModelMD
...
class STTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            type=float,
            default=0.7,
            help="Combine the st attention outputs from ASR encoder and MT encoder",
        )
        group.add_argument(
            "--md_version",
            type=str,
