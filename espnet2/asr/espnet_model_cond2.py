...
class ESPnetASRModelCond2(AbsESPnetModel):
    ...
    def forward(
        ...
        # # bilingual ctc loss
        # encoder_out, encoder_out_lens, _ = self.encoder_hier(encoder_out, encoder_out_lens)
        ...
        #     ) * loss_ctc + self.mono_alpha * loss_mono
