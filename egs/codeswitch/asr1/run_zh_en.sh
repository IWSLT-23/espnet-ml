...
train_set=train_zh_en
train_dev=dev_zh_en
recog_set=test_zh_en
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    fbankdir=fbank
    # utils/combine_data.sh --extra_files textid data/$train_set data/train_zh data/train_en
    # utils/combine_data.sh --extra_files textid data/$train_dev data/dev_zh data/dev_en
    # # utils/combine_data.sh --extra_files textid data/$recog_set data/test_zh data/test_en
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    ...
    python local/add_category.py --input ${feat_dt_dir}/data_${bpemode}${nbpe}.json
fi
