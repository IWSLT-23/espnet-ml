...
# if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    # for x in $train_set test_100h; do
    #     steps/make_fbank_pitch.sh --cmd "$train_cmd" --nj 32 --write_utt2num_frames true \
    #         data/${x} exp/make_fbank/${x} ${fbankdir}
    #     utils/fix_data_dir.sh data/${x}
    # done

    # utils/subset_data_dir.sh --first data/test_100h 5000 data/dev
    # n=$(($(wc -l < data/test_100h/text) - 5000))
    # utils/subset_data_dir.sh --last data/test_100h ${n} data/${recog_set}
    # utils/data/remove_dup_utts.sh 300 data/train_200h data/train_200h_nodup

    # # remove utt having > 2000 frames or < 10 frames or
    # # remove utt having > 400 characters or 0 characters
    # remove_longshortdata.sh --maxchars 400 data/train_200h_nodup data/$train_set
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    ...
    # python local/sym2int.py --text data/$train_set/text --src /data2/brianryan/pika-fork/egs/data/train_small/label.txt \
    ...
    # python local/sym2int.py --text data/$train_dev/text --src /data2/brianryan/pika-fork/egs/data/test/label.txt \
    ...
    #     python local/sym2int.py --text data/$recog_set/text --src /data2/brianryan/pika-fork/egs/data/test/label.txt \
    ...
    python local/add_category.py --input ${feat_tr_dir}/data_${bpemode}${nbpe}.json
fi
...
#     python local/json_to_txttoken.py --input ${feat_tr_dir}/data_${bpemode}${nbpe}.json --output data/${train_set}/text.tok
#     python local/json_to_txttoken.py --input ${feat_dt_dir}/data_${bpemode}${nbpe}.json --output data/${train_dev}/text.tok
...
#     --train-label data/${train_set}/text.tok \
#     --valid-label data/${train_dev}/text.tok \
#     --resume ${lm_resume} \
#     --dict ${dict}
# fi
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        ...
        --verbose ${verbose} \
        --resume ${resume} \
        --train-json ${feat_tr_dir}/data_${bpemode}${nbpe}.json.cat \
        --valid-json ${feat_dt_dir}/data_${bpemode}${nbpe}.json.cat
fi
